  ...
  return (
    <Box sx={{ maxWidth: 700 }}>
      ...
      <Section title="Weekly Summary">
        ...
        <P>A full-width panel lists everything currently open (not done or cancelled) with its age since creation, oldest first, colored by how long it's been sitting (amber past 14 days, red past 30). Status chips show the breakdown across Active / Waiting / Later / etc., and a second row of age chips buckets open items by how long they've been sitting (0–7d / 8–14d / 15–30d / 30d+). This is a live snapshot of what's piling up — it is <em>not</em> bound to the selected date range, unlike every other panel.</P>
        <B>Collaboration</B>
