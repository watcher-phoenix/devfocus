  ...
  return (
    <Box sx={{ maxWidth: 700 }}>
      ...
      <Section title="Weekly Summary">
        ...
        <B>Live Dashboard</B>
        <P>The <strong>Live Dashboard</strong> link in the sidebar opens a full interactive dashboard (at /report) that reads live straight from the database. Pick a rolling preset (7d / 30d / 90d), a calendar preset (WTD / MTD / QTD / YTD — this week, month, quarter, or year to date), or a custom date range. The active window is always spelled out as absolute dates under the title (e.g. "Showing Jun 1 → Jun 24 · 24 days"), and notes when a preset was capped at the start of your history. Every stat compares against the immediately preceding equal-length window and carries a mini weekly-trend sparkline. A row of auto-detected callouts (most productive day, busiest week, after-hours share, maker/manager split, meeting-free days, longest focus block, typical turnaround, active streak, open items, days out of office) sits under the summary. It shows weekly throughput, a maker-vs-manager split with a capacity bar (what % of your working hours is maker/focus time vs manager/meeting time), your strategic-work share over time, the type mix, completions by day of week and by time of day, project momentum (which projects rose or fell vs the prior window), and a per-day activity heatmap — click any day to see the items completed that day (amber ring = after-hours, dashed teal = out of office). The context-switches bar chart is also clickable — click any day's bar to see exactly what you switched between that day — a single chronological timeline that interleaves everything in time order regardless of kind: each work context (the task you picked up, tagged with its project), each meeting, and each non-task yank (with its category and any note you jotted). Tallies logged without a timestamp sort to the end.</P>
        <B>How you work (secondary stats)</B>
        <P>Under the headline row is a second row that looks at <em>how</em> you work, not just how much: <strong>Maker / manager</strong> (share of working hours that is focus vs meetings), <strong>Deep-work days</strong> (workdays with zero meetings, out of the total workdays in range, plus how many were "heavy" with 4+ meetings), <strong>Longest focus block</strong> (the biggest meeting-free stretch inside your work hours, with the day and window it happened), <strong>Typical turnaround</strong> (median days from an item being created to being marked done, with the average and sample size), <strong>Active streak</strong> (consecutive days with completed work — current and longest — plus total active days), and <strong>Open items (now)</strong> (a live count of work not yet done or cancelled).</P>
